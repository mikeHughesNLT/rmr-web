...
const SLIDES = [
  ...
  "Institutional-grade mats. Now live. Yoga, jujutsu, dodgeball — all of it.",
  ...
  "Train here. Recover 200 feet away in the treehouse sauna.",
];
...
export default function FlexHero() {
  ...
  return (
    <section className="relative w-full aspect-video max-h-[80vh] overflow-hidden bg-black">
      <video
        src="/videos/cedar-hall-mats.mp4"
        autoPlay
        muted
        loop
        playsInline
